...
const DeleteAddressModal: React.FC<Props> = ({ open, setOpen, onDelete }) => {
                                        ...
                                        <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                            ...
                                            <div className="mt-2">
                                                <p className="text-sm text-gray-500">
                                                    Are you sure you want to Delete your address? All of your data will
                                                ...
                                                <p className="text-xs text-gray-400 mt-4">
                                                    ...
                                                    wishlists, subscribe and save settings and periodical subscriptions
                                                    using this address.
                                                </p>
                                            </div>
                                        </div>
