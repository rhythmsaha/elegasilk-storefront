        ...
        <div className="w-48">
            <div className="border-b py-2 pb-4">
                <h2 className="text-xl">
                    Hello, <span className="font-medium">Rhythm</span>!
                </h2>
            </div>
            ...
            <div className="flex flex-col mt-3">
                ...
                <button className="flex items-center font-medium py-2 gap-2 text-gray-700 hover:text-gray-950 hover:underline">
