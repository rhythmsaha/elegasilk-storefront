    ...
    return (
        <div className="">
            ...
            <section className="mt-10 w-11/12 mx-auto">
                <div className="grid lg:grid-cols-4 gap-x-10">
                    <div className="lg:col-span-1 flex flex-col justify-between items-center gap-2">
                        <h2 className={`${sourceSerif.className} text-4xl lg:text-4xl text-center `}>Explore Our Best-Selling Sarees!</h2>
            ...
            <section className="mt-20 w-11/12 mx-auto">
                <div>
                    <h2 className={`${sourceSerif.className} text-4xl lg:text-4xl text-center `}>Explore by Fabrics</h2>
                </div>
            ...
            <section className="mt-20 w-11/12 mx-auto">
                <div>
                    <h2 className={`${sourceSerif.className} text-4xl lg:text-4xl text-center `}>Trending Collections</h2>
                </div>
